                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($trow = mysqli_fetch_array($tre)) { {
                                                                            echo "<th>" . $trow['m_id'] . "</th>";
                                                                            echo "<th>" . $trow['m_name'] . "</th>";
                                                                            echo "<th>" . $trow['m_contact'] . "</th>";
                                                                            echo "<th>" . $trow['m_address'] . "</th>";
                                                                            echo "<th>" . $trow['email'] . "</th>";
                                                                            echo "<th  onclick=\"window.location='edit_manager.php?id=" . $trow['m_id'] . "';\">" ?><button
                                                                                type="button"
                                                                                class="print-none btn btn-success">Edit</button>
                                                                            <?php
                                                                            echo "<th onclick=\"deleteManager(" . $trow['m_id'] . ");\">" ?>
                                                                            <button type="button"
                                                            ...
                                                            {
                                                                global $con;
                                                                mysqli_query($con, "DELETE FROM manager WHERE m_id=$id");
                                                                ...
                                                                echo '        window.location = "add-manager.php";';
                                                                echo '    }';
                                                                echo '});';
                                                                echo '</script>';
                                                            }
                                                                ...
                                                                function deleteManager(id) {
                                                                    Swal.fire({
                                                                        ...
                                                                        if (result.isConfirmed) {
                                                                            ...
                                                                            window.location = 'delete_manager.php?id=' + id;
                                                                        }
                                                                    });
                                                                }
                                                            </script>
