...
<body>
    <div id="wrapper">
            ...
            <div id="page-inner">
                ...
                <div class="row">
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input name="newus" class="form-control"
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input name="newps" class="form-control"
                    ...
                    if (isset($_POST['in'])) {
                        ...
                        $newsql = "Insert into admin (name,email,password) values ('$newus','$newem','$newps')";
                                    ...
                                    <form method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input name="usname" value="<?php echo $us; ?>" class="form-control"
                                                    placeholder="Enter User name">
                                            </div>
                                        </div>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input name="usem" value="<?php echo $em; ?>" class="form-control"
        ...
        if (isset($_POST['up'])) {
            ...
            $upsql = "UPDATE `admin` SET `name`='$usname',`email`='$usem',`password`='$passwr' WHERE id = '$id'";
