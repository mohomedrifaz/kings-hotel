                ...
                <div class="col-lg-8">
                    <div class="room-details-item">
                        ...
                        <div class="rd-text">
                            ...
                            <h2>Rs 35000<span>/Pernight</span></h2>
                            <table>
                                <tbody>
                                <tr>
                            ...
                            <p class="f-para">Rooms with an outside view of the hotel surroundings with a choice of large bed having en suite bathroom. 
                                The room features a comfortable sofa, writing desk, spacious closets with full length mirrors, digital safe deposit boxes, 
                                direct dial telephones with voice mail, LCD screens with international and local channels, mini bar, stocked tea/coffee making facility, 
                                free high speed broadband and our all new intelligent mini-bar “Tech Bar” for seamless connectivity to any smart communication gadget. 
                            </p>
                        </div>
                    </div>
